...
class FormulaMissionViewTests(FormulaViewTestCase):
    ...
    def test_report_renders_latex_format_context(self):
        ...
        self.assertNotContains(response, "data-ruler-cursor")
        self.assertNotContains(response, "data-paper-fit-width")
        self.assertNotContains(response, "data-paper-fit-lines")
        self.assertNotContains(response, "data-paper-fit-tight")
