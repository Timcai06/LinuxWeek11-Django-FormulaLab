(function () {
    ...
    function nodes() {
        return {
            ...
            queueControlForm: document.querySelector("[data-queue-control-form]"),
            queueControlCard: document.querySelector(".queue-control-card"),
            queueControlButton: document.querySelector("[data-queue-control-button]"),
            queueControlState: document.querySelector("[data-queue-control-state]"),
            queueControlStatus: document.querySelector("[data-queue-control-status]"),
