...
第二阶段已经完成了草稿纸、公式星图、居中扫描和工作台线框的基础叙事。第三阶段不继续堆叠抽象特效，而是把纸张居中后的终点落到真实产品形态：用户应该在最后一屏看见 Formula Lab 如何从图像公式进入论文编辑、公式审查和协作批注。
...
保留现有首屏：品牌、公式星图、草稿纸、手稿质感和轻量工作台导航。首屏仍然负责吸引用户进入故事。
