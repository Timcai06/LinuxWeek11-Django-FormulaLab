...
第四阶段不是推翻前面的 Living Manuscript。它要保留现有公式星图、草稿纸、扫描解码和 scroll story 的骨架，只把最后的 reveal 从“迷你产品预览”改成“Workbench Gate”。
...
全部公式星图、标题文案、扫描噪声和复杂浮层收束。最终画面只保留：
