...
Review Drawer 和项目级 `.tex/.md` 即时导出已经基于 `PaperProject`、`BatchMission`、`FormulaItem` 落地。Crop Studio、持久化 `ExportArtifact`、Symbol Intelligence 和本地 AI 辅助仍作为后续扩展，不在当前第一片产品核心里一次性完成。
